# Stubs for pendulum.time (Python 3.7)
#
# NOTE: This dynamically typed stub was automatically generated by stubgen.

from .constants import SECS_PER_HOUR, SECS_PER_MIN, USECS_PER_SEC
...
class Time(FormattableMixing, time):
    ...
    def replace(self, hour: Optional[Any] = ..., minute: Optional[Any] = ..., second: Optional[Any] = ..., microsecond: Optional[Any] = ..., tzinfo: bool = ...): ...  # type: ignore
