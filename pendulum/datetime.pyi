...
import datetime
from .constants import ATOM, COOKIE, MINUTES_PER_HOUR, MONTHS_PER_YEAR, RFC1036, RFC1123, RFC2822, RFC822, RFC850, RSS, SATURDAY, SECONDS_PER_DAY, SECONDS_PER_MINUTE, SUNDAY, W3C, YEARS_PER_CENTURY, YEARS_PER_DECADE
...
class DateTime(datetime.datetime, Date):  # type: ignore
    ...
    @classmethod
    def now(cls: Any, tz: Optional[Union[str, Timezone]]=...) -> DateTime: ...  # type: ignore
    @classmethod
    ...
    def replace(self, year: Optional[Any] = ..., month: Optional[Any] = ..., day: Optional[Any] = ..., hour: Optional[Any] = ..., minute: Optional[Any] = ..., second: Optional[Any] = ..., microsecond: Optional[Any] = ..., tzinfo: bool = ..., fold: Optional[Any] = ...): ...  # type: ignore
